...
# Template: subdirs
# Command: C:\Qt\Qt5.4.0\5.4\mingw491_32\bin\qmake.exe -spec win32-g++ -o Makefile FacElectronica.pro
#############################################################################
...
sub-src-qmake_all:  FORCE
	...
	cd src\ && $(QMAKE) C:\trabajos\FacturacionElectronica\C2Si-facelec\src\src.pro -spec win32-g++ -o Makefile
	cd src\ && $(MAKE) -f Makefile qmake_all
sub-src: FORCE
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	cd src\ && ( if not exist Makefile $(QMAKE) C:\trabajos\FacturacionElectronica\C2Si-facelec\src\src.pro -spec win32-g++ -o Makefile ) && $(MAKE) -f Makefile
...
sub-src-all-ordered: FORCE
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	cd src\ && ( if not exist Makefile $(QMAKE) C:\trabajos\FacturacionElectronica\C2Si-facelec\src\src.pro -spec win32-g++ -o Makefile ) && $(MAKE) -f Makefile all
sub-src-all: FORCE
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	cd src\ && ( if not exist Makefile $(QMAKE) C:\trabajos\FacturacionElectronica\C2Si-facelec\src\src.pro -spec win32-g++ -o Makefile ) && $(MAKE) -f Makefile all
sub-src-clean-ordered: FORCE
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	cd src\ && ( if not exist Makefile $(QMAKE) C:\trabajos\FacturacionElectronica\C2Si-facelec\src\src.pro -spec win32-g++ -o Makefile ) && $(MAKE) -f Makefile clean
sub-src-clean: FORCE
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	cd src\ && ( if not exist Makefile $(QMAKE) C:\trabajos\FacturacionElectronica\C2Si-facelec\src\src.pro -spec win32-g++ -o Makefile ) && $(MAKE) -f Makefile clean
sub-src-distclean-ordered: FORCE
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	cd src\ && ( if not exist Makefile $(QMAKE) C:\trabajos\FacturacionElectronica\C2Si-facelec\src\src.pro -spec win32-g++ -o Makefile ) && $(MAKE) -f Makefile distclean
sub-src-distclean: FORCE
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	cd src\ && ( if not exist Makefile $(QMAKE) C:\trabajos\FacturacionElectronica\C2Si-facelec\src\src.pro -spec win32-g++ -o Makefile ) && $(MAKE) -f Makefile distclean
sub-src-install_subtargets-ordered: FORCE
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	cd src\ && ( if not exist Makefile $(QMAKE) C:\trabajos\FacturacionElectronica\C2Si-facelec\src\src.pro -spec win32-g++ -o Makefile ) && $(MAKE) -f Makefile install
sub-src-install_subtargets: FORCE
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	cd src\ && ( if not exist Makefile $(QMAKE) C:\trabajos\FacturacionElectronica\C2Si-facelec\src\src.pro -spec win32-g++ -o Makefile ) && $(MAKE) -f Makefile install
sub-src-uninstall_subtargets-ordered: FORCE
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	cd src\ && ( if not exist Makefile $(QMAKE) C:\trabajos\FacturacionElectronica\C2Si-facelec\src\src.pro -spec win32-g++ -o Makefile ) && $(MAKE) -f Makefile uninstall
...
Makefile: FacElectronica.pro ../../../Qt/Qt5.4.0/5.4/mingw491_32/mkspecs/win32-g++/qmake.conf ../../../Qt/Qt5.4.0/5.4/mingw491_32/mkspecs/features/spec_pre.prf \
		...
		FacElectronica.pro
	$(QMAKE) -spec win32-g++ -o Makefile FacElectronica.pro
...
sub-src-debug_ordered:
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	cd src\ && ( if not exist Makefile $(QMAKE) C:\trabajos\FacturacionElectronica\C2Si-facelec\src\src.pro -spec win32-g++ -o Makefile ) && $(MAKE) -f Makefile debug
debug: sub-src-debug_ordered

sub-src-release_ordered:
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	cd src\ && ( if not exist Makefile $(QMAKE) C:\trabajos\FacturacionElectronica\C2Si-facelec\src\src.pro -spec win32-g++ -o Makefile ) && $(MAKE) -f Makefile release
release: sub-src-release_ordered

sub-src-check_ordered:
	@if not exist src\ mkdir src\ & if not exist src\ exit 1
	cd src\ && ( if not exist Makefile $(QMAKE) C:\trabajos\FacturacionElectronica\C2Si-facelec\src\src.pro -spec win32-g++ -o Makefile ) && $(MAKE) -f Makefile check
